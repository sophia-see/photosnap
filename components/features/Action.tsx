...
export default function Action() {
  ...
  return (
    <div className='relative w-full h-[288px] md:h-[280px]'>
      ...
      <div className='absolute top-0 bottom-0 left-0 right-0 mx-[33px] md:mx-[39px] lg:mx-[120px] xl:mx-[165px] my-[64px] md:my-[68px] text-white flex flex-col items-start gap-6 md:flex-row md:items-center md:justify-between'>
